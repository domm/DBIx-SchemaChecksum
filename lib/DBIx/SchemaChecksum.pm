...
DBIx::SchemaChecksum - The great new DBIx::SchemaChecksum!
...
Perhaps a little code snippet.
    ...
    my $foo = DBIx::SchemaChecksum->new();
    ...
...
Please report any bugs or feature requests to C<bug-dbix-schemachecksum at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=DBIx-SchemaChecksum>.  I will be notified, and then you'll
